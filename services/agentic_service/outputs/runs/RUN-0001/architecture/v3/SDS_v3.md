...
The system follows a modular monolith architecture for the MVP. The application is deployed as one backend service, but internally separated into Identity, Catalog, Cart, Checkout, Order, and Admin modules. This keeps development simple while preserving clear boundaries for future scaling.
