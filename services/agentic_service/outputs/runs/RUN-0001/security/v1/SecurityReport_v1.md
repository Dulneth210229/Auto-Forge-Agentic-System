...
| SEC-002 | Insecure Default CORS Policy | Medium | outputs\runs\RUN-0001\code\v1\generated_app\backend\main.py | 0 | LLM | CWE-22: Path Traversal |
...
### SEC-002 — Insecure Default CORS Policy
...
**Description:**  
The application allows all origins, credentials, and methods by default. This can lead to potential security risks if the API is exposed publicly.

**Recommendation:**  
Restrict CORS policy to only trusted origins and credentials.
...
| SEC-002 | Insecure Default CORS Policy | Medium | Normal | Low |
...
|---|---|---|---:|---|---:|
| Insecure Default CORS Policy | Medium | outputs\runs\RUN-0001\code\v1\generated_app\backend\main.py | 0 | CWE-22: Path Traversal | 1.0 |

### Insecure Default CORS Policy
